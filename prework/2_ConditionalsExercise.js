...
function exercise1(num1) {
  ...
  if (num1 > 10) {
    answer1 = `The value of num1 is ${num1} and it is greater than 10`;
  }
  // ------------------------------------------
  // And above here
  // ------------------------------------------
...
console.log(exercise4(false, true));
console.log(exercise4(true, "true"));
console.log(exercise4(true, 1));
console.log(exercise4(false, "false"));
...
// ! the unexpected case is when passing in a boolean (ie true) and a string ("true"), it would seem that these are equal but in fact they are not because the boolean is considered the number 0 or 1 with type coercion and so it would NOT match the string.
...
console.log(exercise6(8, 8, 8));
console.log(exercise6(8, 8, 9));
console.log(exercise6(7, 8, 8));
...
function exercise8(amount1, amount2, minimum, maximum) {
  ...
  if (amount1 < maximum && amount1 > minimum) {
    if (amount2 < maximum && amount2 > minimum) {
      answer8 = true;
    } else {
      answer8 = false;
    }
...
console.log(exercise8(10, 20, 8, 30));
console.log(exercise8(10, 20, 8, 6));
console.log(exercise8(10, 7, 8, 16));
...
// ! This one was definitely a little more challenging. However, I was able to use MDN Web Docs to solve problems I was confused on.
