...
// ! Numbers 1 and 10 are valid for num2 but not num1.
...
//  ! If a variable is declared but no value assigned, this will be interepreted as undefined
...
// ! === is a strict operator (value and type must be the same);

// # Exercise 19 What is the value of 1 == "1"
const myAnswerForExercise19 = "true";
console.log(1 == "1");

// ! == is a loose operator (only value needs to be the same, type coercion?)
...
// ! operands are always evaluated left to right. (1 < 2) = true = 1 --> (1 < 3) --> true

// # Exercise 22 What is the value of 2 < 1 < 3
const myAnswerForExercise22 = "true";
console.log(2 < 1 < 3);

// ! operands are always evaluated left to right. (2 < 1) = false = 0 --> (0 < 3) --> true

// Congrats, you made it to the end!
// Did you find this easy or hard? If you used references, which ones helped you?
// Please answer in a comment below.

// ! I did not find this too hard. Exercise 21 and 22 did stump me, but I found this resource https://stackoverflow.com/questions/51648057/why-does-3-2-1-return-false-while-1-2-3-returns-true and now everything is crystal clear!
